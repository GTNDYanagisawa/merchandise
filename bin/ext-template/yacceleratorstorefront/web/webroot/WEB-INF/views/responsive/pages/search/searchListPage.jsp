				...
				<ul class="product-listing product-list">
					...
					<li class="product-item">
						...
						<div class="price-panel">
							<div class="promo">You get 1 Power Drill free for
								purchasing 2 Power Drills</div>
							<div class="price msrp">Retail: $988.88</div>

							<div>
								Price: <span class="price"><del>$1988.88</del></span> <span
									class="price"><ins>$988.88</ins><span>
							</div>
						</div>


						<div class="description">Lorem ipsum dolor sit amet,
							consectetur adipisicing elit. Eligendi, nostrum, quibusdam
							necessitatibus consectetur sapiente alias illum fugiat modi
							suscipit harum tempora ratione rerum cupiditate quae nihil
							aliquid cum odit atque.</div>
