...
class OAuth2Tests extends BaseWSTest {
	...
	public static final String USERNAME='democustomer'
	public static final String PASSWORD='1234'

	@Test
	void testGetAccessToken() {
		assert testUtil.getAccessToken(USERNAME, PASSWORD) : 'Unable to obtain access_token!'
	}

	@Test
	void testGetRefreshToken() {
		def tokenMap = testUtil.getAccessTokenMap(USERNAME, PASSWORD)
