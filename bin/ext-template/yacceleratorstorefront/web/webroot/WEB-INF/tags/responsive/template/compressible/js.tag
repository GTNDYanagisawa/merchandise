...
<script type="text/javascript" src="${commonResourcePath}/js/jquery.syncheight.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.tabs.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.zoom.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery-ui-1.10.4.custom.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/picturefill.min.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/jquery.hoverIntent.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.syncheight.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.rwdImageMaps.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.form.js"></script>
