...
<c:if test="${targetArea ne 'accountArea'}">
	<script type="text/javascript">
			...
			if(!$("#differentAddress").is(':checked'))
				{
					...
					$("#tempAddressFirstName").val($("#address.firstName").val());
		...
		function setDeliveryAddress() {
            document.getElementById("address.title").value = "${deliveryAddress.titleCode}";
            document.getElementById("address.firstName").value = "${deliveryAddress.firstName}";
            document.getElementById("address.surname").value = "${deliveryAddress.lastName}";
            document.getElementById("address.line1").value = "${deliveryAddress.line1}";
            document.getElementById("address.line2").value = "${deliveryAddress.line2}";
            document.getElementById("address.townCity").value = "${deliveryAddress.postalCode}";
            document.getElementById("address.postcode").value = "${deliveryAddress.town}";
            document.getElementById("address.country").value = "${deliveryAddress.country.isocode}";
		}
	</script>
</c:if>
