	...
	<div class="span-4 nav_column">
		...
		<div class="item">
			<ul class="facet_block indent">
                ...
                <li class='${selected eq 'entitlements' ? 'nav_selected' : ''}'>
                    <c:url value="/my-account/entitlements" var="encodedUrl" />
                    <ycommerce:testId code="myAccount_entitlements_navLink">
                        <a href="${encodedUrl}" title="<spring:theme code="text.account.entitlements" text="Access & Entitlements"/>"><spring:theme code="text.account.entitlements" text="Access & Entitlements"/></a>
                    </ycommerce:testId>
                </li>
			</ul>
		</div>
