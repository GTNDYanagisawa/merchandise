	...
	<div class="span-20 last">
		...
		<div class="span-20 last">
			<div class="cust_acc">
                ...
                <div class="cust_acc_tile">
                    <c:url value="/my-account/entitlements" var="encodedUrl" />
					<span>
						<spring:message code="text.account.entitlements" var="textAccountEntitlements"/>
						<a href="${encodedUrl}"><theme:image code="img.account.entitlements" alt="${textAccountEntitlements}" title="${textAccountEntitlements}"/></a>
					</span>
                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.entitlements" text="Entitlements"/></a></h1>
                    <ul>
                        <ycommerce:testId code="myAccount_options_entitlements_groupbox">
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.showEntitlements" text="Show your Entitlements"/></a></li>
                        </ycommerce:testId>
                    </ul>
                </div>
			</div>
